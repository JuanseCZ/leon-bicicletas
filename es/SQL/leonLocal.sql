...
BEGIN
UPDATE productos
SET nomProd = nombre, imgProd = img, descripcionProd = descripcion, precio = precio, stock = cantidad, idCat = idCategoria
WHERE idProd = id;
END//
DELIMITER ;
...
CREATE PROCEDURE uDetalle(id INT(10), ticket INT(10), producto INT(10), precio decimal(20,2), unidadesProd INT(10), total INT(10))
BEGIN
  UPDATE detalle
...
CREATE PROCEDURE uCot(id INT(10), cotizacion int, nombre VARCHAR(45), telefono VARCHAR(15), email VARCHAR(45), total decimal(60,2), estado VARCHAR(45))
BEGIN
    UPDATE cotizaciones
...
INSERT INTO
    productos (
    nomProd, imgProd, descripcionProd, precio, stock, idCat
)
VALUES (
...
VALUES (
           'Juan', 'Cardona', '1', 'root', '4813494d137e1631bba301d5acab6e7bb7aa74ce1185d456565ef51d737677b2' -- yH!44@I!3AFI
       ),
       (
