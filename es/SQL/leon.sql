...
BEGIN
    SELECT idProd as identifier, nomProd as nombre, imgProd as imagen, descripcionProd as descripcion, precioProd as valor, stock as cantidad, idCat as categoria
    FROM producto
